...
const THEMES = [
    "nordfox", "nightfox", "carbonfox", "dayfox", "dracula", "onedark", 
    "gruvbox", "material", "monokai", "solarized-dark", "solarized-light",
    "tokyo-night", "catppuccin-mocha", "catppuccin-latte", "rose-pine",
    "ayu-dark", "ayu-light", "github-dark", "github-light", "github-dimmed",
    "nord", "everforest-dark", "everforest-light", "kanagawa", "oxocarbon",
    "poimandres", "tokyo-night-storm", "shades-of-purple", "synthwave",
    "horizon", "sonokai", "material-ocean", "vscode-dark-plus", "palenight",
    "night-owl", "ayu-mirage", "rose-pine-dawn", "tokyo-night-day", "one-light",
    "linear-light", "nord-snow-storm", "zenburn", "panda", "darcula",
    "papercolor-light", "intellij-light", "flat-light", "cobalt2", "monokai-pro",
    "winter-is-coming", "night-owl-light", "oceanic-next", "city-lights",
    "andromeda", "cyberpunk", "jellybeans", "tomorrow-night", "tomorrow-night-eighties",
    "tomorrow-night-blue", "twilight", "espresso", "kimbie-dark", "gruvbox-material",
] as const;
