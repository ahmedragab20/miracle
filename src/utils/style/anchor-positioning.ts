...
@supports (position-anchor: --foo) {
    ...
    /* Logical Flips */
    @position-try --flip-start-to-end {
    ...
    @position-try --flip-end-to-start {
    ...
    /* Start Placement (Logical Left in LTR) */
    [${placementAttr}="start"][${popoverAttr}] {
        inset-inline-end: anchor(start);
        inset-block-start: anchor(center);
        translate: 0 -50%;
        margin-inline-end: 8px;
        position-try-fallbacks: --flip-start-to-end;
    }

    [${placementAttr}="start-start"][${popoverAttr}] {
        inset-inline-end: anchor(start);
    ...
    [${placementAttr}="start-end"][${popoverAttr}] {
        inset-inline-end: anchor(start);
    ...
    /* End Placement (Logical Right in LTR) */
    [${placementAttr}="end"][${popoverAttr}] {
        inset-inline-start: anchor(end);
        inset-block-start: anchor(center);
        translate: 0 -50%;
        margin-inline-start: 8px;
        position-try-fallbacks: --flip-end-to-start;
    }

    [${placementAttr}="end-start"][${popoverAttr}] {
        inset-inline-start: anchor(end);
        inset-block-start: anchor(start);
        margin-inline-start: 8px;
        position-try-fallbacks: --flip-end-to-start;
    ...
    [${placementAttr}="end-end"][${popoverAttr}] {
        inset-inline-start: anchor(end);
        inset-block-end: anchor(end);
        margin-inline-start: 8px;
        position-try-fallbacks: --flip-end-to-start;
