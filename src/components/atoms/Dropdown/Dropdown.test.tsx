...
describe("Dropdown", () => {
    ...
    describe("Placement", () => {
        it("applies start placement", () => {
            const { container } = render(() => (
                <Dropdown trigger={<button>Open</button>} placement="start">
                    <DropdownItem>Item</DropdownItem>
                </Dropdown>
            ));
            const popover = container.querySelector('[popover="auto"]');
            expect(popover).toHaveAttribute("data-dropdown-placement", "start");
        });

        it("applies end placement", () => {
            const { container } = render(() => (
                <Dropdown trigger={<button>Open</button>} placement="end">
                    <DropdownItem>Item</DropdownItem>
                </Dropdown>
            ));
            const popover = container.querySelector('[popover="auto"]');
            expect(popover).toHaveAttribute("data-dropdown-placement", "end");
        });
    });
