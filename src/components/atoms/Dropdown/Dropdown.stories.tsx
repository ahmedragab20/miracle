...
export const SidePlacement: Story = {
    render: (args: Story["args"]) => (
        <div class="flex gap-20 p-12 justify-center items-center">
            <Dropdown
                {...args}
                placement="start"
                trigger={<Button>Start (Left)</Button>}
            >
                <DropdownItem>Item 1</DropdownItem>
                <DropdownItem>Item 2</DropdownItem>
                <DropdownItem>Item 3</DropdownItem>
            ...
            <Dropdown
                {...args}
                placement="end"
                trigger={<Button>End (Right)</Button>}
            >
                <DropdownItem>Item 1</DropdownItem>
                <DropdownItem>Item 2</DropdownItem>
                <DropdownItem>Item 3</DropdownItem>
    ...
    parameters: {
        docs: {
            description: {
                story: "Dropdowns placed on the start (left) or end (right) side.",
            },
        },
    },
};
